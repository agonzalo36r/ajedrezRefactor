...
public class ChessGameBoard extends JPanel {
     ...
     */
    public ChessGameBoard(ChessPanel chesspanel) {
        this.setLayout(new GridLayout(8, 8, 1, 1));
        listener = new BoardListener(chesspanel);
    ...
    private class BoardListener implements MouseListener {
        ...
        public BoardListener(ChessPanel chessPanel) {
			super();
        ...
        public void mouseClicked(MouseEvent e) {
            TareaClick tareaClick = new TareaClick();
            if (e.getButton() == MouseEvent.BUTTON1 &&
                getParent() instanceof ChessPanel) {
                gt.ejecutar(tareaClick, e, chessPanel);
            }
        }
        /**
         * Unused method.
