...
public class ChessGameBoard extends JPanel{
    ...
    public void initializeBoard(){
        ...
        PieceFacade facade = new PieceFacade();
        ...
        for ( int i = 0; i < chessCells.length; i++ ){
            for ( int j = 0; j < chessCells[0].length; j++ ){
                ...
                if ( i == 1 ) // black pawns
                {
                    pieceToAdd = facade.createPawn( this, i, j, ChessGamePiece.BLACK );
                }
                else if ( i == 6 ) // white pawns
                {
                    pieceToAdd = facade.createPawn( this, i, j, ChessGamePiece.WHITE );
                }
                else if ( i == 0 || i == 7 ) // main rows
                {
                    ...
                    if ( j == 0 || j == 7 ){
                        pieceToAdd = facade.createRook( this, i, j, colNum );
                    }
                    else if ( j == 1 || j == 6 ){
                        pieceToAdd = facade.createKnight( this, i, j, colNum );
                    }
                    else if ( j == 2 || j == 5 ){
                        pieceToAdd = facade.createBishop( this, i, j, colNum );
                    }
                    else if ( j == 3 ){
                        pieceToAdd = facade.createKing( this, i, j, colNum );
                    }
                    else
                    {
                        pieceToAdd = facade.createQueen( this, i, j, colNum );
                    }
                }
                else
                {
