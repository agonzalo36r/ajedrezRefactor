...
public abstract class NewChessGamePieceDecorator implements INewChessGamePiece{
    private INewChessGamePiece iNewChessGamePiece;

    public NewChessGamePieceDecorator(INewChessGamePiece iNewChessGamePiece){
        setINewChessGamePiece(iNewChessGamePiece);
    }

    public INewChessGamePiece getINewChessGamePiece(){
        return iNewChessGamePiece;
    }

    public void setINewChessGamePiece (INewChessGamePiece iNewChessGamePiece){
        this.iNewChessGamePiece = iNewChessGamePiece;
    }
     ...
     */
    public abstract ArrayList<String> calculatePossibleMoves(
     ...
     * @return ArrayList<String> the moves in this direction
     */
    public ArrayList<String> calculateNorthWestMoves(
        ChessGameBoard board,
        int numMoves ){
        ArrayList<String> moves = new ArrayList<String>();
        int count = 0;
     ...
     * @return ArrayList<String> the moves in this direction
     */
    public ArrayList<String> calculateNorthEastMoves(
        ChessGameBoard board,
        int numMoves ){
        ArrayList<String> moves = new ArrayList<String>();
        int count = 0;
     ...
     * @return ArrayList<String> the moves in this direction
     */
    public ArrayList<String> calculateSouthWestMoves(
        ChessGameBoard board,
        int numMoves ){
        ArrayList<String> moves = new ArrayList<String>();
        int count = 0;
     ...
     * @return ArrayList<String> the moves in this direction
     */
    public ArrayList<String> calculateSouthEastMoves(
        ChessGameBoard board,
        int numMoves ){
        ArrayList<String> moves = new ArrayList<String>();
        int count = 0;
     ...
     */
    public boolean testMoveForKingSafety(
        ChessGameBoard board,
        int row,
        int col ){
        updatePossibleMoves( board );
        NewChessGamePiece oldPieceOnOtherSquare =
            board.getCell( row, col ).getPieceOnSquare();
    ...
    public boolean isEnemy( ChessGameBoard board, int row, int col ){
        ...
        NewChessGamePiece enemyPiece =
            board.getCell( row, col ).getPieceOnSquare() == null
                ? null
                : board.getCell( row, col ).getPieceOnSquare();
        if ( enemyPiece == null
            || this.getColorOfPiece() == NewChessGamePiece.UNASSIGNED
            || enemyPiece.getColorOfPiece() == NewChessGamePiece.UNASSIGNED ){
            return false;
        }
        if ( this.getColorOfPiece() == NewChessGamePiece.WHITE ){
            if ( enemyPiece.getColorOfPiece() == NewChessGamePiece.BLACK ){
                return true;
            }
            else
            {
        ...
        {
            if ( enemyPiece.getColorOfPiece() == NewChessGamePiece.WHITE ){
                return true;
            }
            else
            {
    ...
    public ArrayList<NewChessGamePiece> getCurrentAttackers( ChessGameBoard board ){
        ArrayList<NewChessGamePiece> attackers = new ArrayList<NewChessGamePiece>();
        int enemyColor =
            ( this.getColorOfPiece() == NewChessGamePiece.BLACK )
